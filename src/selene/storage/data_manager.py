...
class PulseEntry:
    ...
    def validate(self) -> Tuple[bool, str]:
        ...
        from selene.constants import VALID_REST_VALUES, VALID_CLIMATE_VALUES, VALID_CLARITY_VALUES
...
def load_pulse_history() -> List[Dict]:
    ...
    try:
        with open(PULSE_HISTORY_FILE, "r", encoding="utf-8") as f:
            data = json.load(f)
...
def invalidate_all_caches():
    ...
    try:
        from selene.core.context_builder import get_recent_pulse_context, get_pulse_pattern_analysis
